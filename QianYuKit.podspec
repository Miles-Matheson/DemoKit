#
#  Be sure to run `pod spec lint QianYuKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
			"A description of QianYuKit."
                   DESC

  spec.homepage     = "https://github.com/Miles-Matheson/DemoKit"
  ...
  spec.author             = { "Miles" => "liyida188@163.com" }
  # Or just: spec.author    = "Miles"
  # spec.authors            = { "Miles" => "liyida188@163.com" }
  # spec.social_media_url   = "https://twitter.com/Miles"
  ...
  spec.source       = { :git => "https://github.com/Miles-Matheson/DemoKit.git", :tag => "#{spec.version}" }
  ...
  # spec.resource  = "icon.png"
   spec.resources = "QianYuKitBundle/*.{bundle}"
